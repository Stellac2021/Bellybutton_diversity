...
function buildCharts(sample) {
  ...
  d3.json("/resources/samples.json").then((data) => {
    ...
    var result = resultArray[0];
    // 6. Create variables that hold the otu_ids, otu_labels, washing frequency and sample_values.
    ...
    // 14. Create the trace for the guage chart.
    var gaugeData = {
    ...
    // 15. Create the layout for the guage chart. 
    var gaugeLayout = {
      width: 600,
      height: 450, 
      margin: {t: 0, b: 0}
